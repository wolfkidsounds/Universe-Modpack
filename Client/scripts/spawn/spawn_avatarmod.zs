...
spawntabletweaker.removeSpawn("avatarmod:firebender", "AMBIENT");
spawntabletweaker.removeSpawn("avatarmod:firebender", "CREATURE");
spawntabletweaker.removeSpawn("avatarmod:firebender", "MONSTER");

spawntabletweaker.removeSpawn("avatarmod:airbender", "AMBIENT");
spawntabletweaker.removeSpawn("avatarmod:airbender", "CREATURE");
spawntabletweaker.removeSpawn("avatarmod:airbender", "MONSTER");