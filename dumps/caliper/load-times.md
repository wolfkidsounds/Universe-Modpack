...
| Growthcraft Cellar                           | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| MoreOverlays                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | moreoverlays-1.15.1-mc1.12.2.jar                |
| GoreCore                                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | avatarmod-1.5.17-alpha.jar                      |
| NetherEx                                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | NetherEx-1.12.2-2.2.4.jar                       |
| Ender IO Integration with Forestry           | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
| Growthcraft Milk                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| Forge Mod Loader                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | forge-1.12.2-14.23.5.2854.jar                   |
| Better Animals Plus                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | betteranimalsplus-1.12.2-9.0.1.jar              |
...
| bspkrsCore                                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | [1.12]bspkrsCore-universal-7.6.0.1.jar          |
| Cooking for Blockheads                       | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | CookingForBlockheads_1.12.2-6.5.0.jar           |
| Growthcraft Bees                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| FastWorkbench                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FastWorkbench-1.12.2-1.7.3.jar                  |
| InitialInventory                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | InitialInventory-3.0.0.jar                      |
| FTB Library                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FTBLib-5.4.7.2.jar                              |
| §3§lDragon Mounts                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | DragonMounts2-1.12.2-1.6.3.jar                  |
| Custom Loading Screen                        | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | CustomLoadingScreen-1.12.2-1.5.0-pre.1.jar      |
...
| Ender IO Powertools                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
| Growthcraft Apples                           | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| Growthcraft Grapes                           | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| Minecraft Coder Pack                         | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | minecraft.jar                                   |
| SimpleDifficulty                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | SimpleDifficulty-1.12.2-0.3.5.jar               |
...
| Ender IO Conduits                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
| Zero CORE                                    | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | zerocore-1.12.2-0.1.2.9.jar                     |
| Lycanites Mobs                               | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | lycanitesmobs-1.12.2-2.0.7.2.jar                |
...
| Galacticraft Planets                         | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Galacticraft-Planets-1.12.2-4.0.2.281.jar       |
| Blockcraftery                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | blockcraftery-1.12.2-1.3.1.jar                  |
| Extreme Reactors                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | ExtremeReactors-1.12.2-0.4.5.67.jar             |
| No Advancements                              | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | NoAdvancements-1.12.2.002.jar                   |
| Natura                                       | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | natura-1.12.2-4.3.2.69.jar                      |
| Iron Backpacks                               | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | IronBackpacks-1.12.2-3.0.8-12.jar               |
| Fantastic Lib                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FantasticLib-1.12.2.044.jar                     |
...
| Reborn Core                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | RebornCore-1.12.2-3.19.4.529-universal.jar      |
| Phosphor Lighting Engine                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | phosphor-1.12.2-0.2.6+build50-universal.jar     |
| Growthcraft                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| MJRLegendsLib                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | MJRLegendsLib-1.12.2-1.2.0.jar                  |
| InstantUnify                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | instantunify-1.12.2-1.1.2.jar                   |
| Growthcraft Fishtrap                         | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| BiblioCraft                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | BiblioCraft[v2.4.5][MC1.12.2].jar               |
| Primitive Mobs                               | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | primitivemobs-1.2.3a.jar                        |
| VanillaFix                                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | VanillaFix-1.0.10-150.jar                       |
| Elevator Mod                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | ElevatorMod-1.12.2-1.3.14.jar                   |
| Ender IO                                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
...
| EnderTweaker                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderTweaker-1.12.2-1.2.1.jar                   |
...
| Progressive Bosses                           | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | ProgressiveBosses-1.5.4-mc1.12.x.jar            |
| Micdoodle8 Core                              | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | minecraft.jar                                   |
| Land Manager                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | landmanager-1.12.2-1.5.0.jar                    |
| Just Enough HarvestCraft                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | just-enough-harvestcraft-1.12.2-1.7.2.jar       |
| Ender IO Integration with Tinkers' Construct | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
| FoamFixCore                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | minecraft.jar                                   |
| Forge Microblocks                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | ForgeMultipart-1.12.2-2.6.2.83-universal.jar    |
| CT-GUI                                       | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | CraftTweaker2-1.12-4.1.20.618.jar               |
...
| Ender IO Inventory Panel                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
...
| SecurityCraft                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | [1.12.2] SecurityCraft v1.8.21.jar              |
...
| CraftTweaker2                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | CraftTweaker2-1.12-4.1.20.618.jar               |
| Netherending Ores                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Netherending-Ores-1.12.2-1.4.2.jar              |
| Avatar Mod: Out of the Iceberg               | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | avatarmod-1.5.17-alpha.jar                      |
...
| Growthcraft Bamboo                           | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
| Just Enough Items                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | jei_1.12.2-4.16.1.301.jar                       |
...
| Biomes O' Plenty                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | BiomesOPlenty-1.12.2-7.0.1.2441-universal.jar   |
| MrCrayfish's Furniture Mod                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | furniture-6.3.1-1.12.2.jar                      |
...
| Quick Leaf Decay                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | QuickLeafDecay-MC1.12.1-1.2.4.jar               |
...
| Material Changer                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | materialchanger1.0.3-1.12.2.jar                 |
| Aroma1997's Dimensional World                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | Aroma1997s-Dimensional-World-1.12.2-2.0.0.2.jar |
| Tinker's JEI                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | tinkersjei-1.2.jar                              |
| Atum 2                                       | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Atum-1.12.2-2.0.20.jar                          |
| Galacticraft Core                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | GalacticraftCore-1.12.2-4.0.2.281.jar           |
...
| Enchanting Plus                              | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | EnchantingPlus-1.12.2-5.0.176.jar               |
| InfinityLib                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | infinitylib-1.12.0.jar                          |
| Minecraft Multipart Plugin                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | ForgeMultipart-1.12.2-2.6.2.83-universal.jar    |
| Vending                                      | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | vending-1.12.2-3.0.1.2.jar                      |
| Ender IO Machines                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderIO-1.12.2-5.2.66.jar                       |
| FTB Backups                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FTBBackups-1.1.0.1.jar                          |
| End: Reborn                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EndReborn+[0.3.9].jar                           |
| Food Tweaker                                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FoodTweaker-1.1.3.jar                           |
| Signals                                      | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Signals-1.12.2-1.4.1-30-universal.jar           |
...
| Bountiful                                    | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Bountiful-2.2.2.jar                             |
| The Twilight Forest                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | twilightforest-1.12.2-3.11.1021-universal.jar   |
...
| TreeCapitator                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | [1.12]TreeCapitator-client-1.43.0.jar           |
...
| Scannable                                    | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Scannable-MC1.12.2-1.6.3.26.jar                 |
| Foamflower                                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | foamflower-1.12.2-1.0.0.0-beta1.jar             |
...
| galacticrafttweaker                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | GalacticraftTweaker-1.12.2-1.0.3.jar            |
...
| Extra Planets                                | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | ExtraPlanets-1.12.2-0.7.2.jar                   |
| Avatar Addon Mod                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Avatar Armory AddOn Mod v1.1.2.jar              |
| Growthcraft Rice                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
...
| Tektopia HarvestCraft Compat                 | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Tektopia-Harvestcraft-Compat-1.3.jar            |
| UniverseMod                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | UniverseMod_[1.12.2]_a1.9.jar                   |
...
| TekTopia                                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | tektopia-1.1.0.jar                              |
...
| Deep Mob Learning                            | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | deepmoblearning-1.12.2-2.5.4-universal.jar      |
| EnderCore                                    | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderCore-1.12.2-0.5.76.jar                     |
| Forge Multipart CBE                          | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | ForgeMultipart-1.12.2-2.6.2.83-universal.jar    |
| Rare Ice                                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | rare-ice-0.1.0.jar                              |
...
| Ender Zoo                                    | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | EnderZoo-1.12.1-1.4.0.49.jar                    |
...
| Pam's Cookables                              | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | pamscookables-1.1.jar                           |
| CraftTweaker JEI Support                     | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | CraftTweaker2-1.12-4.1.20.618.jar               |
...
| Pam's BrewCraft                              | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Pam's BrewCraft 1.12.2-1.0.2.jar                |
...
| Mekanism: Tools                              | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | MekanismTools-1.12.2-9.8.3.390.jar              |
...
| Just Enough Reactors                         | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | JustEnoughReactors-1.12.2-1.1.3.61.jar          |
...
| Pam's Simple Recipes                         | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | Pam's Simple Recipes 1.12.2c.jar                |
| Wall-Jump!                                   | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | walljump-1.12.2-1.3.2.jar                       |
| §3Dynamic Surroundings                       | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | true            | DynamicSurroundings-1.12.2-3.6.1.0.jar          |
...
| Growthcraft Hops                             | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | growthcraft-1.12.2-4.2.2.1.jar                  |
...
| Food Expansion                               | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | FoodExpansion1.3.3-1.12.2.jar                   |
| U Team Core                                  | 0.0s       | 0.0s     | 0.0s | 0.0s | 0.0s      | false           | u_team_core-1.12.2-2.2.5.147.jar                |
